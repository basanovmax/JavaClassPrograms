...
missingChar("kitten", 4) → "kittn" */
    ...
    return the string with the 2 chars added at both
    ...
    the string starts with "hi" and false otherwise.
    ...
    either of them is in the range 10..20 inclusive.
    ...
    at index 1, return a string where that "del" has been deleted.
   ...
   delDel("adelbc") → "abc"
    ...
    the event of a tie. Note that Math.abs(n)
...
lastDigit(3, 113) → true*/
    ...
    uppercase whatever is there. Note that
