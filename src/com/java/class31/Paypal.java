...
//as an argument, so if we have 100 banks, we need to create 100 different methods
//for each bank to support one feature.

//Instead we can take reference of parent so we can store object of any child class
